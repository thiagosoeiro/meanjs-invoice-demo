(function () {
  ...
  describe('Admin Invoices List Controller Tests', function () {
    // Initialize global variables
    var InvoicesAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _InvoicesService_) {
      ...
      $httpBackend.whenGET('/modules/invoices/client/views/list-invoices.client.view.html').respond(200, '');
      ...
      InvoicesAdminListController = $controller('InvoicesAdminListController as vm', {
        $scope: $scope
      });
