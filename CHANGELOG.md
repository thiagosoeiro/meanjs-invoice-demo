...
* fix(invoice): add callback for remove invoice (#1534) ([a7aebbd](https://github.com/meanjs/mean/commit/a7aebbd)), closes [#1274](https://github.com/meanjs/mean/issues/1274)
* fix(invoices): Invoice controllers name conflicts (#1428) ([c96f8c0](https://github.com/meanjs/mean/commit/c96f8c0))
* fix(invoices): Invoice edit/delete validation ([69b8a05](https://github.com/meanjs/mean/commit/69b8a05)), closes [#1146](https://github.com/meanjs/mean/issues/1146)
* fix(invoices): Orphaned User reference throws server error ([2bdde4e](https://github.com/meanjs/mean/commit/2bdde4e)), closes [#1082](https://github.com/meanjs/mean/issues/1082)
...
* add bootstrap class 'unstyled' to remove bullet points in invoice list ([cb62e46](https://github.com/meanjs/mean/commit/cb62e46))
* add bootstrap class 'unstyled' to remove bullet points in invoice list ([b9d9b61](https://github.com/meanjs/mean/commit/b9d9b61))
...
* Added Invoice Delete Support ([eeb5423](https://github.com/meanjs/mean/commit/eeb5423))
...
* Adding karma-ng-html2js-preprocessor to fix karma tests.  Adding user mock to invoices tests. ([c468539](https://github.com/meanjs/mean/commit/c468539))
...
* adding proper handling for invalid model ObjectIds passed on to invoice routes ([5bccbdd](https://github.com/meanjs/mean/commit/5bccbdd))
...
* adding test to check proper handling when no invoice exists ([9952138](https://github.com/meanjs/mean/commit/9952138))
...
* Allow Guests to view Invoices ([cbebed9](https://github.com/meanjs/mean/commit/cbebed9))
...
* Invoice Cleanup ([c11c428](https://github.com/meanjs/mean/commit/c11c428))
* Invoices Example Fix ([ccf7eb3](https://github.com/meanjs/mean/commit/ccf7eb3))
* Invoices Example Fix ([6b0109e](https://github.com/meanjs/mean/commit/6b0109e))
* Invoices Example Fix ([6598c04](https://github.com/meanjs/mean/commit/6598c04))
* Invoices Example Fix ([23dc7a3](https://github.com/meanjs/mean/commit/23dc7a3))
...
* Clean up invoice example ([0b3dead](https://github.com/meanjs/mean/commit/0b3dead))
...
* Dummy config directory for the invoices module to make it easier for developers to understand and re ([903b4ca](https://github.com/meanjs/mean/commit/903b4ca))
...
* Fixing invoice and express 4 modification ([5ff49a7](https://github.com/meanjs/mean/commit/5ff49a7))
* Fixing invoices ([38f08ff](https://github.com/meanjs/mean/commit/38f08ff))
* Fixing Invoices Issues ([f132e10](https://github.com/meanjs/mean/commit/f132e10))
...
* fixing issue #348 - instead of returning a server error 500 on invoice loading which isnt found we'l ([56aff70](https://github.com/meanjs/mean/commit/56aff70))
...
* Fixing style, adding invoice test ([c42c8eb](https://github.com/meanjs/mean/commit/c42c8eb))
...
* Fixing user details exposure in invoices example ([0cfbafa](https://github.com/meanjs/mean/commit/0cfbafa))
...
* More Naming Fixes, invoices cleanup ([edd549d](https://github.com/meanjs/mean/commit/edd549d))
...
* Remove console.log from an invoice test ([a8dae99](https://github.com/meanjs/mean/commit/a8dae99))
...
* Remove ng-init directive from invoice list. ([7770ccc](https://github.com/meanjs/mean/commit/7770ccc))
...
* should return done(err) in invoice server route test ([d00f4ce](https://github.com/meanjs/mean/commit/d00f4ce))
...
* The invoice middleware was calling getErrorMessage with a null argument, causing a crash when this m ([71167b0](https://github.com/meanjs/mean/commit/71167b0))
...
* Update create-invoice.client.view.html ([3949400](https://github.com/meanjs/mean/commit/3949400))
...
* Update form-invoice.client.view.html ([7ffbd3f](https://github.com/meanjs/mean/commit/7ffbd3f))
...
* Use form validation in invoices ([e56c76a](https://github.com/meanjs/mean/commit/e56c76a))
...
* feat(invoices): Invoice Admin feature (#807) ([89075cb](https://github.com/meanjs/mean/commit/89075cb))
* feat(invoices): InvoicesService extended $resource (#1266) ([a7370a7](https://github.com/meanjs/mean/commit/a7370a7))
* feat(invoices): Modify invoices module to implement style guidelines. ([b3ad56e](https://github.com/meanjs/mean/commit/b3ad56e)), closes [#874](https://github.com/meanjs/mean/issues/874) [#339](https://github.com/meanjs/mean/issues/339)
* feat(invoices): Rename list.invoices.client.controller.js to list-invoices.client.controller.js ([a014ffc](https://github.com/meanjs/mean/commit/a014ffc)), closes [#1192](https://github.com/meanjs/mean/issues/1192)
...
* BUG: Removed a ng-binding to invoice.content in user-list.client.view.html ([2747df6](https://github.com/meanjs/mean/commit/2747df6))
* formatting: indent ([b8d6fa7](https://github.com/meanjs/mean/commit/b8d6fa7))
* Feature: Invoice CRUD ops. Added supertests. closes meanjs/mean#92 ([2ec6fa0](https://github.com/meanjs/mean/commit/2ec6fa0)), closes [meanjs/mean#92](https://github.com/meanjs/mean/issues/92)
...
* Merge pull request #890 from lirantal/feature/invoice-module-dummy-config-dir ([bd1a7d7](https://github.com/meanjs/mean/commit/bd1a7d7))
...
* Merge pull request #781 from codydaig/bug/listInvoicesAuth ([0be1b11](https://github.com/meanjs/mean/commit/0be1b11))
